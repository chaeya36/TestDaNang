...
const MOCK_TRIP_DATA: TripData = {
  ...
  itinerary: [
    ...
    },
    {
      ...
      why: "다낭 시내 핵심 코스. 환전(한시장 금은방) 및 아오자이 맞춤. (평지 이동)",
      tips: ["부모님이 힘들어하시면 콩카페에서 쉬시게 하고 교대 쇼핑 추천", "한시장 1층 냄새 주의"],
      rainAlternative: {
        name: "한시장 (실내 쇼핑)",
    ...
    },
    {
      ...
      why: "케이블카로 정상까지 편하게 이동하는 다낭 필수 코스. 부모님과 사진 찍기 좋은 골든브릿지.",
      tips: ["등산 전혀 없음 (세계 최장 케이블카 탑승)", "많이 걸어야 하니 편한 신발 필수", "산 위는 쌀쌀하니 겉옷 준비"],
      rainAlternative: {
        name: "바나힐 판타지 파크 (실내)",
    ...
    },
    {
      ...
      closedDays: "연중무휴",
      routeFromPrev: {
        distanceMeters: 28000, durationSec: 2400, durationWalkingSec: undefined, durationPublicTransportSec: undefined,
        fareEstimateVND: { grab4: { min: 350000, max: 400000 }, grab7: { min: 400000, max: 500000 } }
      }
    },
    {
    ...
    },
    {
      ...
      why: "유네스코 유산. 부모님이 걷기 힘드실 수 있으니 씨클로(자전거 인력거)를 타고 편하게 둘러보는 것을 추천합니다.",
    ...
    },
    {
      ...
      durationMin: 0, costVND: { min: 0, max: 0 },
      why: "호이안 일정 후 새로운 숙소로 이동 (D34 An Thượng 34, Mỹ An).",
